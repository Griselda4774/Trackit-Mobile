...
class ProductItemCanceled extends StatelessWidget {
  late orderDTO order;
  ProductItemCanceled({super.key, required this.order});
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            if (order.orderDetailList.first.productList.first
                                    .productOption !=
                                null)
                              Text(
